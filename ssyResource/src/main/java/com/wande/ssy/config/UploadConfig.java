...
import com.wande.ssy.utils.UploadUtil;
...
//	public static final String Upload_File_Dir   = "/file/";		// 其它文件上传目录
	...
	public static final String getWebRootPath() {
		String LinuxRootPath = ConfigManager.getStringByKey("eqp.uploadPath", "");
		if (StringUtil.isEmpty(LinuxRootPath)) {
	 ...
	 * @return
	 */
	public static String getAppDownloadUrl(HttpServletRequest request) {
		return PathUtil.getHostPathExt(request) + appDownloadUrl;
	}
}
